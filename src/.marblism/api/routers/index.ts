...
import createJobOfferRouter from "./JobOffer.router";
...
import { ClientType as JobOfferClientType } from "./JobOffer.router";
...
export function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        jobOffer: createJobOfferRouter(router, procedure),
...
export interface ClientType<AppRouter extends AnyRouter> {
    ...
    jobOffer: JobOfferClientType<AppRouter>;
