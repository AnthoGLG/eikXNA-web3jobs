...
export const Theme = {
  ...
  components: {
    ...
    Layout: {
      headerBg: '#F9FCFF', // topBar background color
      footerBg: '#F9FCFF', // footer background color
      bodyBg: '#F3F4F8', // page background color
      siderBg: '#F9FCFF', // leftBar background color
    },
    Menu: {
